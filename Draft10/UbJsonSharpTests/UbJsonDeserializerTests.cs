...
namespace UbJsonSharpTests
{
    class UbJsonDeserializerTests
    {
        ...
        public void ShouldDeserializeStcArrayOfBytes ()
        {
            ...
            var bytes = new List<byte>();
            bytes.AddRange(new byte[] { UbJsonCommon.StcArrayMarker, UbJsonCommon.Int8Marker, 0x03, UbJsonCommon.UInt8Marker, 0x41, 0x42, 0x43 });
        ...
        public void ShouldDeserializeStcArrayOfBoolean ()
        {
            ...
            var bytes = new List<byte>();
            bytes.AddRange(new byte[] { UbJsonCommon.StcArrayMarker, UbJsonCommon.Int8Marker, 0x03, UbJsonCommon.FalseMarker, 0x54, 0x46, 0x54 });
